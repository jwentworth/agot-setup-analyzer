...
var DeckActionID = (function () {
    ...
    DeckActionID.LOAD_DECK = "DECK.LOAD_DECK";
...
var SetupActionID = (function () {
    ...
    SetupActionID.PERFORM_SIMULATIONS = "SETUP.PERFORM_SIMULATIONS";
    SetupActionID.NEXT_EXAMPLE = "SETUP.NEXT_EXAMPLE";
    ...
    SetupActionID.TOGGLE_REQUIRE_ECON = "SETUP.TOGGLE_REQUIRE_ECON";
...
var SetupActionsStatic = (function () {
    ...
    SetupActionsStatic.prototype.runSimulations = function (runs) {
        this.dispatcher.dispatch({
            actionType: SetupActionID.PERFORM_SIMULATIONS,
            data: runs
        });
    };
    SetupActionsStatic.prototype.test = function (from) {
        this.dispatcher.dispatch({
...
},{"../dispatcher/appDispatcher":17,"./setupActionId":6}],4:[function(require,module,exports){
...
var DeckImport = (function (_super) {
    ...
    DeckImport.prototype.handleImportDeck = function (event) {
        var text = ReactDOM.findDOMNode(this.refs["deckText"]).value;
        SetupActions_1.SetupActions.test("actions");
        AppDispatcher.dispatch({
            actionType: SetupActionID.TEST,
            data: "direct"
        });
...
var Simulation = (function (_super) {
    ...
    Simulation.prototype.getStateFromStores = function () {
        return {
    ...
    Simulation.prototype.rerunSimulation = function () {
        AppDispatcher.dispatch({
            actionType: SetupActionID.PERFORM_SIMULATIONS,
            data: 5000
        });
...
var CardSettings = (function (_super) {
    ...
    CardSettings.prototype.onMarkAvoided = function () {
        AppDispatcher.dispatch({
            actionType: DeckActionID.MARK_AVOID_CARD,
            data: this.props.card.code
        });
    };
    CardSettings.prototype.onMarkRestricted = function () {
        AppDispatcher.dispatch({
...
var Configure = (function (_super) {
    ...
    Configure.prototype.toggleMulliganOnPoor = function () {
        AppDispatcher.dispatch({
            actionType: SetupActionID.TOGGLE_MULIGAN_ON_POOR,
            data: null
        });
    };
    Configure.prototype.toggleMulliganWithoutKey = function () {
        AppDispatcher.dispatch({
            actionType: SetupActionID.TOGGLE_MULIGAN_WITHOUT_KEY,
            data: null
        });
    };
    Configure.prototype.toggleRequireEcon = function () {
        AppDispatcher.dispatch({
    ...
    Configure.prototype.toggleRequireFourCostCharacter = function () {
        AppDispatcher.dispatch({
...
var SetupExample = (function (_super) {
    ...
    SetupExample.prototype.onNext = function () {
        var index = this.state.shownSetup + 1;
    ...
    SetupExample.prototype.render = function () {
        var _this = this;
        var i = 0;
        var exampleItems = null;
        if (this.props.setups[this.state.shownSetup]) {
            exampleItems = this.props.setups[this.state.shownSetup].draw.map(function (pos) {
                i++;
...
var SimulationStats = (function (_super) {
    ...
    SimulationStats.prototype.getBaseGoldConfig = function () {
        var goldUsageData = {
            title: {
                text: 'Gold Used'
            },
    ...
    SimulationStats.prototype.render = function () {
        ...
        var i = 0;
        var orderedDeck = deck.sort(function (c1, c2) { return c2.setup_count - c1.setup_count; });
...
var DeckStoreStatic = (function () {
    ...
    DeckStoreStatic.prototype.subscribe = function (onChange) {
        this.onChanges.push(onChange);
    };
    DeckStoreStatic.prototype.inform = function () {
        this.onChanges.forEach(function (cb) { cb(); });
    };
    DeckStoreStatic.prototype.getDisplayDeck = function () {
        return this.displayDeck;
    };
    DeckStoreStatic.prototype.getDrawDeck = function () {
        return this.drawDeck;
    };
    DeckStoreStatic.prototype.getCard = function (code) {
        var cards = this.getDisplayDeck().filter(function (c) { return c.code == code; });
        if (cards.length >= 0) {
            return cards[0];
        }
        return null;
    };
    DeckStoreStatic.prototype.markKeyCard = function (code) {
    ...
    DeckStoreStatic.prototype.addMarshalEffects = function (card) {
...
var SetupStoreStatic = (function () {
    ...
    SetupStoreStatic.prototype.subscribe = function (onChange) {
        this.onChanges.push(onChange);
    };
    SetupStoreStatic.prototype.inform = function () {
        this.onChanges.forEach(function (cb) { cb(); });
    };
    ...
    SetupStoreStatic.prototype.validateSetup = function (setup) {
        var _this = this;
        if (setup.hasAttachment && setup.distinctCharacters == 0) {
            return false;
        }
        var attachments = setup.cards.map(function (c) { return _this.deck.getDrawDeck()[c]; }).filter(function (c) { return c.type_code == 'attachment'; });
        var characters = setup.cards.map(function (c) { return _this.deck.getDrawDeck()[c]; }).filter(function (c) { return c.type_code == 'character'; });
        var unattachables = attachments.filter(function (att) {
            var regex = att.attachmentRestriction.reduce(function (prev, curr) { return (prev ? prev + "|" : "") + curr; }, "");
            var traitRegex = new RegExp(regex);
            var targetCharacters = characters.filter(function (c) {
                if (c.attachmentRestriction) {
                    var attachmentRestriction = new RegExp(c.attachmentRestriction.reduce(function (prev, curr) { return (prev ? prev + "|" : "") + curr; }, ""));
    ...
    SetupStoreStatic.prototype.setUp = function (setup, remainingCards) {
    ...
    SetupStoreStatic.prototype.updateStats = function (stats, setup) {
    ...
    SetupStoreStatic.prototype.toggleMulliganWithoutKey = function () {
    ...
    SetupStoreStatic.prototype.toggleRequireEcon = function () {
    ...
    SetupStoreStatic.prototype.toggleRequireFourCostCharacter = function () {
...
},{"../actions/setupActionID":5,"../dispatcher/AppDispatcher":16,"./deckStore":18}],20:[function(require,module,exports){
(function (process){
/**
...
},{"react":180}],25:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./CSSProperty":27,"./ReactPerf":95,"./dangerousStyleValue":129,"_process":23,"fbjs/lib/ExecutionEnvironment":154,"fbjs/lib/camelizeStyleName":156,"fbjs/lib/hyphenateStyleName":167,"fbjs/lib/memoizeStringOnly":174,"fbjs/lib/warning":179}],29:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":46,"./PooledClass":47,"_process":23,"fbjs/lib/invariant":168}],30:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Danger":35,"./ReactMultiChildUpdateTypes":91,"./ReactPerf":95,"./setInnerHTML":148,"./setTextContent":149,"_process":23,"fbjs/lib/invariant":168}],33:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"_process":23,"fbjs/lib/invariant":168}],34:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./DOMProperty":33,"./ReactPerf":95,"./quoteAttributeValueForBrowser":146,"_process":23,"fbjs/lib/warning":179}],35:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"_process":23,"fbjs/lib/ExecutionEnvironment":154,"fbjs/lib/createNodesFromMarkup":159,"fbjs/lib/emptyFunction":160,"fbjs/lib/getMarkupWrap":164,"fbjs/lib/invariant":168}],36:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./EventPluginRegistry":40,"./EventPluginUtils":41,"./ReactErrorUtils":80,"./accumulateInto":126,"./forEachAccumulated":134,"_process":23,"fbjs/lib/invariant":168,"fbjs/lib/warning":179}],40:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"_process":23,"fbjs/lib/invariant":168}],41:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./EventConstants":38,"./ReactErrorUtils":80,"_process":23,"fbjs/lib/invariant":168,"fbjs/lib/warning":179}],42:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./EventConstants":38,"./EventPluginHub":39,"./accumulateInto":126,"./forEachAccumulated":134,"_process":23,"fbjs/lib/warning":179}],43:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactPropTypeLocations":97,"./ReactPropTypes":98,"_process":23,"fbjs/lib/invariant":168,"fbjs/lib/warning":179}],46:[function(require,module,exports){
/**
...
},{"_process":23,"fbjs/lib/invariant":168}],48:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactInstanceMap":86,"./findDOMNode":132,"_process":23,"fbjs/lib/warning":179}],50:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactReconciler":100,"./instantiateReactComponent":142,"./shouldUpdateReactComponent":150,"./traverseAllChildren":151,"_process":23,"fbjs/lib/warning":179}],52:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":46,"./ReactComponent":54,"./ReactElement":76,"./ReactNoopUpdateQueue":93,"./ReactPropTypeLocationNames":96,"./ReactPropTypeLocations":97,"_process":23,"fbjs/lib/emptyObject":161,"fbjs/lib/invariant":168,"fbjs/lib/keyMirror":171,"fbjs/lib/keyOf":172,"fbjs/lib/warning":179}],54:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactNoopUpdateQueue":93,"./canDefineProperty":128,"_process":23,"fbjs/lib/emptyObject":161,"fbjs/lib/invariant":168,"fbjs/lib/warning":179}],55:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"_process":23,"fbjs/lib/invariant":168}],57:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":46,"./ReactComponentEnvironment":56,"./ReactCurrentOwner":58,"./ReactElement":76,"./ReactInstanceMap":86,"./ReactPerf":95,"./ReactPropTypeLocationNames":96,"./ReactPropTypeLocations":97,"./ReactReconciler":100,"./ReactUpdateQueue":106,"./shouldUpdateReactComponent":150,"_process":23,"fbjs/lib/emptyObject":161,"fbjs/lib/invariant":168,"fbjs/lib/warning":179}],58:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactCurrentOwner":58,"./ReactDOMTextComponent":70,"./ReactDefaultInjection":73,"./ReactInstanceHandles":85,"./ReactMount":89,"./ReactPerf":95,"./ReactReconciler":100,"./ReactUpdates":107,"./ReactVersion":108,"./findDOMNode":132,"./renderSubtreeIntoContainer":147,"_process":23,"fbjs/lib/ExecutionEnvironment":154,"fbjs/lib/warning":179}],60:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":76,"./ReactElementValidator":77,"_process":23,"fbjs/lib/mapObject":173}],63:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./DOMChildrenOperations":32,"./DOMPropertyOperations":34,"./ReactMount":89,"./ReactPerf":95,"_process":23,"fbjs/lib/invariant":168}],65:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./LinkedValueUtils":45,"./Object.assign":46,"./ReactDOMIDOperations":64,"./ReactMount":89,"./ReactUpdates":107,"_process":23,"fbjs/lib/invariant":168}],66:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":46,"./ReactChildren":52,"./ReactDOMSelect":67,"_process":23,"fbjs/lib/warning":179}],67:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./LinkedValueUtils":45,"./Object.assign":46,"./ReactMount":89,"./ReactUpdates":107,"_process":23,"fbjs/lib/warning":179}],68:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./DOMChildrenOperations":32,"./DOMPropertyOperations":34,"./Object.assign":46,"./ReactComponentBrowserEnvironment":55,"./ReactMount":89,"./escapeTextContentForBrowser":131,"./setTextContent":149,"./validateDOMNesting":152,"_process":23}],71:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./LinkedValueUtils":45,"./Object.assign":46,"./ReactDOMIDOperations":64,"./ReactUpdates":107,"_process":23,"fbjs/lib/invariant":168,"fbjs/lib/warning":179}],72:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":46,"./ReactCurrentOwner":58,"./canDefineProperty":128,"_process":23}],77:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactCurrentOwner":58,"./ReactElement":76,"./ReactPropTypeLocationNames":96,"./ReactPropTypeLocations":97,"./canDefineProperty":128,"./getIteratorFn":139,"_process":23,"fbjs/lib/invariant":168,"fbjs/lib/warning":179}],78:[function(require,module,exports){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"_process":23}],81:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactRootIndex":102,"_process":23,"fbjs/lib/invariant":168}],86:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":46,"./ReactChildren":52,"./ReactClass":53,"./ReactComponent":54,"./ReactDOMFactories":62,"./ReactElement":76,"./ReactElementValidator":77,"./ReactPropTypes":98,"./ReactVersion":108,"./onlyChild":145,"_process":23}],88:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactChildReconciler":51,"./ReactComponentEnvironment":56,"./ReactCurrentOwner":58,"./ReactMultiChildUpdateTypes":91,"./ReactReconciler":100,"./flattenChildren":133,"_process":23}],91:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":46,"_process":23,"fbjs/lib/invariant":168}],93:[function(require,module,exports){
(function (process){
/**
...
},{"_process":23,"fbjs/lib/warning":179}],94:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"_process":23,"fbjs/lib/invariant":168}],95:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":46,"./ReactCurrentOwner":58,"./ReactElement":76,"./ReactInstanceMap":86,"./ReactUpdates":107,"_process":23,"fbjs/lib/invariant":168,"fbjs/lib/warning":179}],107:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./CallbackQueue":29,"./Object.assign":46,"./PooledClass":47,"./ReactPerf":95,"./ReactReconciler":100,"./Transaction":124,"_process":23,"fbjs/lib/invariant":168}],108:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./EventConstants":38,"./EventPropagators":42,"./ReactMount":89,"./SyntheticClipboardEvent":113,"./SyntheticDragEvent":115,"./SyntheticEvent":116,"./SyntheticFocusEvent":117,"./SyntheticKeyboardEvent":119,"./SyntheticMouseEvent":120,"./SyntheticTouchEvent":121,"./SyntheticUIEvent":122,"./SyntheticWheelEvent":123,"./getEventCharCode":135,"_process":23,"fbjs/lib/EventListener":153,"fbjs/lib/emptyFunction":160,"fbjs/lib/invariant":168,"fbjs/lib/keyOf":172}],113:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":46,"./PooledClass":47,"_process":23,"fbjs/lib/emptyFunction":160,"fbjs/lib/warning":179}],117:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"_process":23,"fbjs/lib/invariant":168}],125:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"_process":23,"fbjs/lib/invariant":168}],127:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"_process":23}],129:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":46,"_process":23,"fbjs/lib/warning":179}],131:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactCurrentOwner":58,"./ReactInstanceMap":86,"./ReactMount":89,"_process":23,"fbjs/lib/invariant":168,"fbjs/lib/warning":179}],133:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./traverseAllChildren":151,"_process":23,"fbjs/lib/warning":179}],134:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":46,"./ReactCompositeComponent":57,"./ReactEmptyComponent":78,"./ReactNativeComponent":92,"_process":23,"fbjs/lib/invariant":168,"fbjs/lib/warning":179}],143:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":76,"_process":23,"fbjs/lib/invariant":168}],146:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactCurrentOwner":58,"./ReactElement":76,"./ReactInstanceHandles":85,"./getIteratorFn":139,"_process":23,"fbjs/lib/invariant":168,"fbjs/lib/warning":179}],152:[function(require,module,exports){
(function (process){
/**
 * Copyright 2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":46,"_process":23,"fbjs/lib/emptyFunction":160,"fbjs/lib/warning":179}],153:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 *
...
},{"./emptyFunction":160,"_process":23}],154:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ExecutionEnvironment":154,"./createArrayFromMixed":158,"./getMarkupWrap":164,"./invariant":168,"_process":23}],160:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ExecutionEnvironment":154,"./invariant":168,"_process":23}],165:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"_process":23}],169:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./invariant":168,"_process":23}],172:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./invariant":168,"_process":23}],179:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./emptyFunction":160,"_process":23}],180:[function(require,module,exports){
'use strict';
